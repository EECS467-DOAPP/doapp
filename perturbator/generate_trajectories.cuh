...
__device__ void compute_noisy_trajectories(unsigned int num_noise_vectors, unsigned int dimensionality, float* noise_vectors, float* trajectories, float* noisy_trajectories);
